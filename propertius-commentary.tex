...
\lem{constantis \lips fastus} is genitive of description with \textit{lumina}.  Propertius once was proud, but now he is forced to keep his eyes lowered.  Again this suggests a subordinate status for Propertius.\indent\lem{lumina}: The word \textit{lumen} is often used in Latin to mean \textit{oculus}.
